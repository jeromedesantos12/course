const GOOGLE_API_KEY = "AIzaSyCblXzPEdTCdu1Qx5bboquHCpY-RkW8IWU";
...
export async function getAddress(lat, lng) {
  const url = `https://maps.googleapis.com/maps/api/geocode/json?address=${lat},${lng}&key=${GOOGLE_API_KEY}`;
